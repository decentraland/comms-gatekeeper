 ...
 *
 * No result cache: the ban half is answered from the in-memory ban registry, which a ban or
 * lift updates before anything else is told, so every lookup is both cheap and current.
 *
