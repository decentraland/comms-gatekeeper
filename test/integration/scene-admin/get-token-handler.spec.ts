...
test('GET /private-conversations/token', ({ components, stubComponents }) => {
  describe('when the user is in the blocklist', () => {
    ...
    it('should respond with a 401', async () => {
      const response = await makeRequest(components.localFetch, '/private-conversations/token')
  ...
  describe('when the user is not in the blocklist', () => {
    ...
    describe('and retrieving a token for the private conversations is successful', () => {
      beforeEach(() => {
    ...
    describe('and retrieving a token for the private conversations fails', () => {
      beforeEach(() => {
